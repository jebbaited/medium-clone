...
export const UserBar: FC<Props> = ({
  ...
  const pathToProfile =
    creatorData?._id && creatorData?.name
      ? `/profile/${creatorData._id}/${creatorData.name}`
      : '/';
          ...
          <Link to={pathToProfile}>
            <div>
              <img
                ...
                alt="nothing"
                src={creatorData?.avatar ? creatorData.avatar : imgSrc(null)}
              />
            </div>
          </Link>
